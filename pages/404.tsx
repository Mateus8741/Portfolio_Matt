      ...
      {num404 !== "0000" && (
        <div className="min-h-screen w-full flex items-center justify-center flex-col animate-fadeIn">
          ...
          <p className="text-fun-gray text-xl mt-8 flex items-center">
            ...
            <Link href="/">
              <span className="w-full sm:w-auto flex-shrink border border-purple-800 text-base px-4 py-1 rounded-xl text-purple-800 bg-fun-pink-darkerer hover:bg-purple-800 hover:text-white transition-colors cursor-pointer">
                Voltar
              </span>
            </Link>
          </p>
